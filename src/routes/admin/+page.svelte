<script lang="ts">
  import { TrendingUp, TrendingDown, Users, CreditCard, DollarSign, Activity, Info } from '@lucide/svelte';
  ...
  let topTransactions = $state([
    { id: '#FWB127364372', user: 'Bonnie Green', date: 'Apr 23, 2021', amount: 2300, status: 'Completed' },
    { id: '#FWB125467980', user: 'Jese Leos', date: 'Apr 23, 2021', amount: 5467, status: 'Completed' },
    { id: '#FWB139587023', user: 'Thomas Lean', date: 'Apr 18, 2021', amount: 3902, status: 'Cancelled' },
    { id: '#FWB142592348', user: 'Lana Byrd', date: 'Apr 15, 2021', amount: 203, status: 'In progress' },
  ]);
...
<div class="space-y-4 sm:space-y-6">
  ...
  <div class="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-4 transition-all hover:border-gray-300 sm:rounded-2xl sm:p-6">
      <div class="mb-3 flex items-start justify-between sm:mb-4">
        <div class="flex-1">
          <div class="mb-2 flex items-center space-x-2 sm:mb-3">
            ...
            <div class="min-w-0">
              <p class="text-sm font-semibold text-gray-900 sm:text-base">Revenue</p>
      ...
      <div class="flex items-center space-x-1 border-t border-gray-100 pt-3">
        {#if stats.revenueChange > 0}
          ...
          <span class="text-sm font-medium text-green-600">+{stats.revenueChange}%</span>
        {:else}
          <TrendingDown class="h-4 w-4 text-red-600" />
          <span class="text-sm font-medium text-red-600">{stats.revenueChange}%</span>
        {/if}
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-4 transition-all hover:border-gray-300 sm:rounded-2xl sm:p-6">
      <div class="mb-3 flex items-start justify-between sm:mb-4">
        <div class="flex-1">
          <div class="mb-2 flex items-center space-x-2 sm:mb-3">
            ...
            <div class="min-w-0">
              <p class="text-sm font-semibold text-gray-900 sm:text-base">Total Users</p>
      ...
      <div class="flex items-center space-x-1 border-t border-gray-100 pt-3">
        <TrendingUp class="h-4 w-4 text-green-600" />
        <span class="text-sm font-medium text-green-600">+{stats.usersChange}%</span>
        <span class="text-sm text-gray-500">vs last month</span>
      </div>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-4 transition-all hover:border-gray-300 sm:rounded-2xl sm:p-6">
      <div class="mb-3 flex items-start justify-between sm:mb-4">
        <div class="flex-1">
          <div class="mb-2 flex items-center space-x-2 sm:mb-3">
            ...
            <div class="min-w-0">
              <p class="text-sm font-semibold text-gray-900 sm:text-base">Transactions</p>
      ...
      <div class="flex items-center space-x-1 border-t border-gray-100 pt-3">
        <TrendingUp class="h-4 w-4 text-green-600" />
        <span class="text-sm font-medium text-green-600">+{stats.transactionsChange}%</span>
        <span class="text-sm text-gray-500">vs last month</span>
      </div>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-4 transition-all hover:border-gray-300 sm:rounded-2xl sm:p-6">
      <div class="mb-3 flex items-start justify-between sm:mb-4">
        <div class="flex-1">
          <div class="mb-2 flex items-center space-x-2 sm:mb-3">
            ...
            <div class="min-w-0">
              <p class="text-sm font-semibold text-gray-900 sm:text-base">Active Agents</p>
      ...
      <div class="flex items-center space-x-1 border-t border-gray-100 pt-3">
        <TrendingUp class="h-4 w-4 text-green-600" />
        <span class="text-sm font-medium text-green-600">+{stats.agentsChange}%</span>
        <span class="text-sm text-gray-500">vs last month</span>
      </div>
    </div>
  </div>
  ...
  <div class="rounded-xl border border-gray-200 bg-white p-4 transition-all hover:border-gray-300 sm:rounded-2xl sm:p-6 lg:p-8">
    <div class="mb-4 flex items-center justify-between sm:mb-6">
      ...
      <div class="flex items-center space-x-1">
        ...
        <span class="text-xs font-medium text-green-600 sm:text-sm">Growing</span>
      </div>
    </div>
    ...
    <!-- Info box -->
    <div class="mt-4 flex items-start space-x-2 rounded-lg border border-blue-200 bg-blue-50 p-2 sm:p-3">
  ...
  <div class="rounded-xl border border-gray-200 bg-white p-4 transition-all hover:border-gray-300 sm:rounded-2xl sm:p-6">
    <div class="mb-4 flex items-center justify-between sm:mb-6">
      <div>
        <h3 class="text-base font-semibold text-gray-900 sm:text-lg">Latest Transactions</h3>
        <p class="text-xs text-gray-500 sm:text-sm">Recent platform activity</p>
      </div>
      <a href="/admin/transactions" class="text-sm font-medium text-blue-600 hover:text-blue-700">
        View all →
      </a>
    </div>
        ...
        <div class="flex items-center justify-between rounded-lg border border-gray-100 p-3 transition-all hover:border-gray-200 sm:p-4">
          <div class="flex items-center space-x-3 sm:space-x-4">
            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gray-50 sm:h-12 sm:w-12">
              <span class="text-sm font-bold text-gray-900">{tx.user.charAt(0)}</span>
            </div>
            <div class="min-w-0">
              <p class="truncate text-sm font-semibold text-gray-900 sm:text-base">{tx.user}</p>
              <p class="text-xs text-gray-500 sm:text-sm">{tx.id} • {tx.date}</p>
            </div>
          </div>
          <div class="flex items-center space-x-3 sm:space-x-4">
            <span class="font-mono text-sm font-bold text-gray-900 sm:text-base">
