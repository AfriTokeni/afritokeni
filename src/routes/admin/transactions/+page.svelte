...
<div class="space-y-4 sm:space-y-6">
  ...
  <!-- Transactions List -->
  <div
    class="rounded-xl border border-gray-200 bg-white transition-all hover:border-gray-300 sm:rounded-2xl"
  >
  ...
  >
    ...
    <div class="text-xs text-blue-900 sm:text-sm">
      ...
      <p class="mt-1 text-blue-800">
        This feed updates automatically every 10 seconds. Use filters to narrow
        down specific transaction types or statuses.
      </p>
    </div>
  </div>
</div>
