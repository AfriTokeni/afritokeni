  ...
  <div class="space-y-6 rounded-xl border border-gray-200 bg-white p-6">
    ...
    <div class="rounded-lg border border-orange-200 bg-orange-50 p-4">
      <p class="text-sm text-orange-800">
        <strong>Network Fee:</strong> ~0.0001 ckBTC will be deducted for transaction
        fees
      </p>
    </div>
    ...
    <button
      onclick={handleSend}
      disabled={isSending}
      class="w-full rounded-lg bg-orange-600 py-3 font-semibold text-white hover:bg-orange-700 disabled:opacity-50"
    >
