...
export const DAO_CONFIG = {
	MIN_TOKENS_TO_PROPOSE: Number(PUBLIC_DAO_MIN_TOKENS_TO_PROPOSE) || 1000,
	MIN_TOKENS_TO_VOTE: Number(PUBLIC_DAO_MIN_TOKENS_TO_VOTE) || 1,
	QUORUM_PERCENTAGE: Number(PUBLIC_DAO_QUORUM_PERCENTAGE) || 10,
	PASS_THRESHOLD: Number(PUBLIC_DAO_PASS_THRESHOLD) || 50,
	VOTING_PERIOD_DAYS: Number(PUBLIC_DAO_VOTING_PERIOD_DAYS) || 7,
} as const;
