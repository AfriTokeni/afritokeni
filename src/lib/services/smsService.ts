...
if (
  ...
  console.log(
    "⚠️  Africa's Talking running in DEMO mode (no real SMS will be sent)",
  );
  console.log(
    "Set AT_USERNAME and AT_API_KEY environment variables for real SMS",
  );
}
...
export async function sendBulkSMS(
  ...
  try {
    ...
    const errors = result.SMSMessageData.Recipients.filter(
      (r: any) => r.status !== "Success",
