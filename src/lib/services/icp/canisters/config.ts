...
export const AFRITOKENI_FEE_CANISTER_ID =
  getEnv("VITE_AFRITOKENI_FEE_CANISTER_ID") || "aaaaa-aa"; // Placeholder - deploy canister first
...
export const AFRITOKENI_PRINCIPAL_ID =
  getEnv("VITE_AFRITOKENI_PRINCIPAL_ID") || "aaaaa-aa"; // Placeholder - set up DAO principal first
 ...
 */
export const AGENT_COMMISSION_CUT = 0.1; // 10%
...
export function logCanisterConfig() {
  ...
  console.log(
    "✅ All user balances are stored on-chain in user-controlled principals",
  );
}
