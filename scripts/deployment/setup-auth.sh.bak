...
dfx canister call data_canister add_authorized_canister "(\"${USER_CANISTER}\")" --network ${NETWORK}
echo -e "${GREEN}  ✅ User Canister authorized${NC}"

dfx canister call data_canister add_authorized_canister "(\"${WALLET_CANISTER}\")" --network ${NETWORK}
echo -e "${GREEN}  ✅ Wallet Canister authorized${NC}"

dfx canister call data_canister add_authorized_canister "(\"${CRYPTO_CANISTER}\")" --network ${NETWORK}
echo -e "${GREEN}  ✅ Crypto Canister authorized${NC}"

dfx canister call data_canister add_authorized_canister "(\"${AGENT_CANISTER}\")" --network ${NETWORK}
